  ...
  actions: {
    load() {
      try {
        ...
        if (data) {
          ...
          if (data.hasOwnProperty('hrButtonVisible')) this.hrButtonVisible = !!data.hrButtonVisible
          if (data.splitPlan) {
    ...
    save() {
      uni.setStorageSync(SETTINGS_KEY, {
        ...
        hrButtonVisible: this.hrButtonVisible,
    ...
    toggleHrButton() {
      this.hrButtonVisible = !this.hrButtonVisible
      this.save()
    },
