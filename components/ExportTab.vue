  ...
  <view class="export-tab">
    ...
    <view class="export-section">
      ...
      <view v-if="includeTemplates" class="template-selection">
        ...
        <view class="template-list">
          <view v-for="template in templates" :key="template.name"
    ...
    <view class="date-picker-modal" v-if="showDatePicker" @click.self="showDatePicker = false">
      <view class="modal-content">
        <DateRangePicker :availableDates="availableDates" :initialDates="selectedDates" @confirm="onDatesConfirm"
      ...
      loadTemplates() {
        try {
          ...
          if (data && Array.isArray(data)) {
            // 排除有氧模板
            this.templates = data.filter(t => !t.isAerobic)
